...
import net.dragoteen.ywformc.block.custom.AscanikIslandDoor;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, YoKaiWatchForMinecraftMod.MODID);

    public static final RegistryObject<Block> BLOC_DE_MAGNETITE = registryBlock("bloc_de_magnetite",
